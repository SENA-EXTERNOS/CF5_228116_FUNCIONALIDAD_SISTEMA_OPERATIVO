    ...
    .row.justify-content-center.align-items-stretch.pt-5.text-center
      .col-lg-6.bg4(data-aos="fade-right")
        ...
        .p-5.pt-0
          ...
          p.mb-0 Consiste en la conexión de un equipo a la red y acomodar todos los paquetes, dependiendo el área que corresponda respetando las reglas. Todas las grandes organizaciones y compañías optan por usar este firewall. Este debe ir conectado entre el router y el internet. Una de las principales características es que, al cumplir con todas las propiedades de funcionamiento, no se presentan novedades o daños, y por tanto no ocupa tanto espacio de memoria. Al momento de realizar mantenimiento suele ser muy difícil de actualizar. Por tal razón la persona idónea para revisar debe ser alguien con experiencia para evitar daños en otras funciones. 
